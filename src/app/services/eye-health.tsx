...
import { RiHealthBookLine, RiEyeLine } from '@remixicon/react';
  ...
  const tips = [
    {
      ...
      description:
        'Manter os olhos limpos e evitar contato com mãos sujas previne infecções.',
      Icon: RiHealthBookLine,
    },
    {
      title: 'Exames Regulares',
      description:
        'Consultas periódicas ajudam na detecção precoce de problemas de visão.',
      Icon: RiEyeLine,
    },
    {
      title: 'Proteção contra luz azul',
      description:
        'Óculos com filtro de luz azul ajudam a reduzir a fadiga ocular causada por telas.',
      Icon: Info,
    },
    {
      title: 'Alimentação saudável',
      description:
        'Vitaminas A, C e E, e ômega-3 contribuem para uma visão saudável.',
      Icon: Check,
    },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <section className="relative w-full h-100 md:h-125 lg:h-150 overflow-hidden">
        <img
          src="https://images.pexels.com/photos/15770385/pexels-photo-15770385.jpeg"
          alt="Saúde ocular Eye Plus Óptico"
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          ...
          >
            ...
            <p className="mt-4 text-white/90 max-w-2xl mx-auto">
              Orientações especializadas para prevenção, cuidados diários e manutenção da saúde dos seus olhos.
            </p>
          </motion.div>
        </div>
      </section>
